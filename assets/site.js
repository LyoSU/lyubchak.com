...
const T = {
 en:{hdr_cta:"Message me",me_cta:"Message me on Telegram",role:"<b>AI Platform Architect.</b> I build production AI systems and run Telegram products used by millions of people.",
  nw_t:"Live News",nw_sub:"Ukraine’s news from every source at once",nw_ch:"channels read",nw_acc:"categories right · my own model",nw_line:"One event, one story, and you see where the sources disagree.",nw_surf:'<span><b>news.yuri.ly</b></span><span><b>@UAliveNews</b> · all news</span><span><b>@ShortUA</b> · the short of it</span>',cp_tag:"Give it the work. Get the finished files.",fs_mau:"monthly users",fs_sub:"The largest sticker platform on Telegram",fs_packs:"sticker packs",fs_inst:"Android installs",fs_surf:'<span><b>Bot</b> · create stickers</span><span><b>Catalog</b> · browse & search</span><span><b>Android app</b></span>',
  ...
  gh_sub:"open-source stars",bt_lab:"More bots",st_lab:"Stack",st_t:"It’s no longer the point",st_s:"With AI, a new tool takes days to pick up. These are just the ones I reach for most.",op_lab:"Open for",op_t:"AI & automation for companies",op_s:"Systems that run on real data and existing infrastructure.",op_btn:'Write me<i class="ic ic-go" aria-hidden="true"></i>',
 ...
 uk:{hdr_cta:"Написати",me_cta:"Написати в Telegram",role:"<b>AI Platform Architect.</b> Будую AI-системи для продакшну і розвиваю Telegram-продукти, якими користуються мільйони людей.",
  nw_t:"Живі новини",nw_sub:"Новини України з усіх джерел одразу",nw_ch:"каналів читає",nw_acc:"категорій влучно · моя модель",nw_line:"Одна подія — одна новина, і видно, де джерела розходяться.",nw_surf:'<span><b>news.yuri.ly</b></span><span><b>@UAliveNews</b> · усі новини</span><span><b>@ShortUA</b> · коротко про головне</span>',cp_tag:"Дай йому роботу — отримай готові файли.",fs_mau:"користувачів на місяць",fs_sub:"Найбільша платформа стікерів у Telegram",fs_packs:"стікерпаків",fs_inst:"встановлень Android",fs_surf:'<span><b>Бот</b> · створення паків</span><span><b>Каталог</b> · пошук</span><span><b>Android</b>-застосунок</span>',
  ...
  gh_sub:"зірок на відкритому коді",bt_lab:"Інші боти",st_lab:"Стек",st_t:"Це вже не головне",st_s:"З AI новий інструмент освоюється за дні. Тут лише те, що під рукою найчастіше.",op_lab:"Відкритий до",op_t:"AI та автоматизація для компаній",op_s:"Системи, що працюють на реальних даних і наявній інфраструктурі.",op_btn:'Написати<i class="ic ic-go" aria-hidden="true"></i>',
